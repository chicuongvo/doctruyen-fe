...
import { createSlug } from "../../utils/date"; // Đảm bảo đã thêm hàm này trong utils/date.ts
...
export default function ItemCardV2({ showTags, story, onClick }: ItemCardV2Props) {
  const slug = createSlug(story.title); // Tạo slug từ tiêu đề
