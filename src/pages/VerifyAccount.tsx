...
export default function VerifyAccount() {
  ...
  return (
    <div className="dark:bg-white dark:text-black bg-black font-spartan px-4 py-5 lg:px-60 text-white flex justify-center">
      {contextHolder}

      <div className="dark:bg-zinc-100 bg-zinc-800 px-6 py-15 rounded-[25px] border-zinc-600 border flex flex-col justify-center items-center gap-5 md:w-3/5">
