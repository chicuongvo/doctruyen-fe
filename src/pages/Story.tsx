  ...
  return (
    <div className="bg-black p-8 text-white font-spartan">
      ...
      <div className="flex justify-center gap-4">
        ...
        <button
          className="flex cursor-pointer items-center justify-center w-55 h-13 gap-2 px-6 py-3 rounded-xl text-white font-medium bg-gradient-to-r from-purple-600 to-purple-400 transition-all duration-300 hover:from-purple-400 hover:to-purple-600"
